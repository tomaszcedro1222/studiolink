(() => {
  ...
  const english = new Map(Object.entries({
    ...
    'Studio podcastowe i videocastowe w centrum Warszawy. 3 kamery, 4 mikrofony i realizator w cenie. Poznaj cennik i sprawdź wolne terminy online.': 'Podcast and videocast studio in central Warsaw. 3 cameras, 4 microphones and a producer included. See pricing and check availability online.',
    'Podcasty i videocasty z pełną obsługą realizatora w centrum Warszawy.': 'Podcasts and videocasts with full producer support in central Warsaw.',
    'Studio Link — studio podcastowe i videocastowe w Warszawie': 'Studio Link — podcast and videocast studio in Warsaw',
    ...
    'Studio Link • Warszawa': 'Studio Link • Warsaw',
    'Studio podcastowe w Warszawie z pełną realizacją audio i wideo': 'Podcast studio in Warsaw with full audio and video production',
    'Przyjeżdżasz z pomysłem, a my przygotowujemy scenografię, kamery, mikrofony i realizację. Studio Link to profesjonalne studio nagrań w centrum Warszawy dla firm, twórców, ekspertów i zespołów marketingowych. Realizator jest w cenie, dlatego nie musisz kompletować osobnej ekipy technicznej.': 'You bring the idea and we prepare the set, cameras, microphones and production. Studio Link is a professional recording studio in central Warsaw for companies, creators, experts and marketing teams. A producer is included, so you do not need to arrange a separate technical crew.',
    'Podcasty i videocasty': 'Podcasts and videocasts',
    'Nagrywamy czysty dźwięk i obraz z trzech kamer. Materiał realizujemy na żywo i przekazujemy w chmurze lub na Twoim dysku.': 'We record clean audio and video from three cameras. We produce the material live and deliver it in the cloud or on your drive.',
    'Webinary i transmisje na żywo': 'Webinars and live streams',
    'Zapewniamy przygotowane studio, realizację obrazu i dźwięku oraz wsparcie techniczne podczas streamingu i wydarzeń online.': 'We provide a prepared studio, video and audio production and technical support during streams and online events.',
    'Rolki, castingi i filmy szkoleniowe': 'Reels, castings and training videos',
    'Dopasowujemy ustawienie studia do krótkich formatów social media, nagrań eksperckich, kursów, castingów i komunikacji marki.': 'We tailor the studio setup to short social formats, expert recordings, courses, castings and brand communications.',
    'Zobacz': 'See', 'cennik studia': 'studio pricing', 'sprawdź': 'check', 'wolne terminy': 'available times', 'albo': 'or', 'porozmawiaj z realizatorem': 'talk to the producer', 'o swoim projekcie.': 'about your project.',
    ...
    'Co obejmuje wynajem Studio Link?': 'What is included when renting Studio Link?',
    'W cenie otrzymujesz przygotowane studio, trzy kamery, cztery mikrofony oraz realizację obrazu i dźwięku. Realizator prowadzi nagranie na żywo, więc nie musisz organizować osobnej ekipy technicznej.': 'The price includes a prepared studio, three cameras, four microphones and video and audio production. A producer runs the recording live, so you do not need to arrange a separate technical crew.',
    'Jakie materiały można nagrać w Studio Link?': 'What can you record at Studio Link?',
    'Realizujemy podcasty audio, videocasty, webinary, transmisje na żywo, rolki, castingi online i filmy szkoleniowe. Ustawienie studia dobieramy do formatu i identyfikacji marki.': 'We produce audio podcasts, videocasts, webinars, live streams, reels, online castings and training videos. We tailor the studio setup to the format and brand identity.',
    'Gdzie znajduje się studio i czy ma parking?': 'Where is the studio and is parking available?',
    'Studio Link mieści się przy ul. Langiewicza 16/1, 02-071 Warszawa. To lokalizacja w centrum Warszawy, a dla klientów dostępny jest prywatny parking.': 'Studio Link is located at 16/1 Langiewicza Street, 02-071 Warsaw. It is a central Warsaw location and private parking is available for clients.',
    'Jak zarezerwować termin nagrania?': 'How do I book a recording session?',
    'Wybierz datę, godzinę i długość sesji w': 'Choose the date, time and session length in the', 'kalendarzu na stronie': 'online calendar', ', a następnie wyślij formularz. Możesz też zadzwonić pod numer': ', then submit the form. You can also call', 'lub napisać na': 'or email',
    ...
    'Ostatnia aktualizacja: 17 lipca 2026 r.': 'Last updated: 17 July 2026', '1. Administrator danych': '1. Data controller',
    ...
    'Do zarządzania zgodami na pliki cookies korzystamy z platformy Cookiebot. Cookiebot zapisuje informacje niezbędne do zapamiętania Twojego wyboru oraz umożliwia osobne wyrażenie zgody na poszczególne kategorie cookies. Osadzone odtwarzacze YouTube są ładowane dopiero po wyrażeniu zgody na cookies marketingowe i kliknięciu wybranej realizacji. Bez tej zgody w ich miejscu pozostają lokalne zdjęcia. Swoją decyzję możesz w każdej chwili zmienić przez przycisk „Ustawienia cookies” w stopce.': 'We use Cookiebot to manage cookie consent. Cookiebot stores the information required to remember your choice and lets you consent separately to individual cookie categories. Embedded YouTube players load only after you consent to marketing cookies and select a project. Without that consent, local images remain in their place. You can change your choice at any time using “Cookie settings” in the footer.',
    '7. Usługi zewnętrzne': '7. External services', 'Strona korzysta z Google Fonts, Google Tag Manager, Google Analytics oraz Meta Pixel. Narzędzia analityczne i marketingowe są uruchamiane zgodnie z wyborem dokonanym w Cookiebocie. W module realizacji korzystamy również z osadzonych odtwarzaczy YouTube w trybie zwiększonej prywatności, które są ładowane dopiero po wyrażeniu zgody na cookies marketingowe. Połączenie z serwerami tych dostawców może wiązać się z przekazaniem adresu IP, danych technicznych przeglądarki oraz zapisaniem danych niezbędnych do działania tych usług.': 'The website uses Google Fonts, Google Tag Manager, Google Analytics and Meta Pixel. Analytics and marketing tools are activated according to your choices in Cookiebot. Our work section also uses embedded YouTube players in privacy-enhanced mode, which load only after consent to marketing cookies. Connecting to these providers may involve sharing your IP address and technical browser data and storing information required for these services.',
